        ...
        <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=updatemedic" role="form">
                ...
                <div class="col-md-6">
                    <select name="category_id" class="form-control">
                        ...
                        <option value="<?php echo $cat->id; ?>"
                            <?php if($user->category_id==$cat->id){ echo "selected"; }?>><?php echo $cat->name; ?>
                        </option>
                        <?php endforeach;?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" name="address" value="<?php echo $user->address;?>" class="form-control" required
                        id="username" placeholder="Direccion">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <button type="submit" class="btn medico">Actualizar Medico</button>
                </div>
            </div>
        </form>
    </div>
